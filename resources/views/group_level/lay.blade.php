...
<!-- Mirrored from demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/dashboards/crm.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Aug 2022 07:02:03 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('assets/img/start_logo.jfif') }}">
    <link rel="icon" type="image/png" href="{{ asset('assets/img/start_logo.jfif') }}">
    <title>
        @yield('title')
    </title>
    ...
    <meta name="twitter:image" content="{{ asset('s3.amazonaws.com/creativetim_bucket/products/487/thumb/opt_sdp_thumbnail.jpg') }}">
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="#" target="">
            <img src="{{ asset('assets/img/start_logo.jfif') }}" class="navbar-brand-img h-100" style="" alt="main_logo">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#dashboardsExamples2" class="nav-link" aria-controls="dashboardsExamples2" role="button" aria-expanded="false">
                    ...
                    <span class="nav-link-text ms-1">Clusters</span>
                </a>
                <div class="collapse" id="dashboardsExamples2">
                    <ul class="nav ms-4 ps-3">

                        <li class="nav-item ">
                            <a class="nav-link " href="{{ route('super_admin/add_clusters') }}">
                                <span class="sidenav-mini-icon"> A </span>
                                <span class="sidenav-normal"> Add Cluster & Facility </span>
                            </a>
                        </li>

                        <li class="nav-item ">
                            <a class="nav-link " href="{{ route('super_admin/view_clusters') }}">
                                <span class="sidenav-mini-icon"> V </span>
                                <span class="sidenav-normal"> View Clusters & Facilities</span>
                            </a>
                        </li>
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#dashboardsExamples3" class="nav-link" aria-controls="dashboardsExamples2" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>shop </title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="collapse" id="dashboardsExamples3">
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " href="{{ route('super_admin/add_users') }}">
                                <span class="sidenav-mini-icon"> A </span>
                                <span class="sidenav-normal"> Add User </span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link " href="{{ route('super_admin/group_level_users') }}">
                                <span class="sidenav-mini-icon"> G </span>
                                <span class="sidenav-normal">Group Level </span>
                            </a>
                        </li> <li class="nav-item ">
                            <a class="nav-link " href="{{ route('super_admin/cluster_level_users') }}">
                                <span class="sidenav-mini-icon"> C </span>
                                <span class="sidenav-normal">Cluster Level </span>
                            </a>
                        </li> <li class="nav-item ">
                            <a class="nav-link " href="{{ route('super_admin/facility_level_users') }}">
                                <span class="sidenav-mini-icon"> F </span>
                                <span class="sidenav-normal">Facility Level </span>
                            </a>
                        </li> <li class="nav-item ">
                            <a class="nav-link " href="{{ route('super_admin/recoder_level_users') }}">
                                <span class="sidenav-mini-icon"> R </span>
                                <span class="sidenav-normal">Recorders</span>
                            </a>
                        </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('group/user_view') }}" target="">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center  me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>credit-card</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('group/data_field_view') }}" target="">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center  me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>credit-card</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Data Fields Submission</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('group/over_view') }}" target="">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center  me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>credit-card</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Graphical Overview</span>
                </a>
            </li>
        </ul>
    </div>
            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                ...
                <ul class="navbar-nav  justify-content-end">
                    <li class="nav-item d-flex align-items-center">
                        <a href="javascript:void(0)" onclick="document.getElementById('logout-form').submit();" class="nav-link text-body font-weight-bold px-0">
