            ...
            <div class="col-12">
                <div class="card widget-calendar h-100">
                    ...
                    <div class="card-header p-3 pb-0">
                        <h5 class="mb-0">View Facility Level Users</h5>
                        <div class="d-flex">
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-flush">
                                ...
                                @foreach($facility_levels as $facility_level)
                                    ...
                                    <tr>
                                        <td class="text-sm font-weight-normal">{{$facility_level->id}}</td>
                                        <td class="text-sm font-weight-normal">{{$facility_level->name}} &nbsp {{$facility_level->lname}}</td>
                                        <td class="text-sm font-weight-normal">{{$facility_level->email}}</td>
                                        <td class="text-sm font-weight-normal">{{$facility_level->role}}</td>
                                        <td class="text-sm font-weight-normal">{{$facility_level->cluster->name}}</td>
                                        <td class="text-sm font-weight-normal">{{$facility_level->garment->name}}</td>
                                        <td class="text-sm font-weight-normal">  <a href="#" onclick="" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-container="body" data-animation="true"><i class="ni ni-settings"></i></a>&nbsp
                                            <a href="{{ route('super_admin/remove-user', $facility_level->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" data-container="body" data-animation="true"> <i class="ni ni-scissors"></i></a></td>
