...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('recoder/dashboard') }}" target="_blank">
            ...
            <div class="col-12">
                <div class="card widget-calendar h-100">
                    ...
                    <div class="card-header p-3 pb-0">
                        <h4 class="mb-0">{{auth()->user()->cluster->name}} &nbsp {{auth()->user()->garment->name}}</h4>
                        <div class="d-flex">
...
<!-- Mirrored from demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/dashboards/crm.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Aug 2022 07:02:10 GMT -->
</html>
