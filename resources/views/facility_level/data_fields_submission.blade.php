                        ...
                        <div class="card-body p-3">
                            <div class="row">
                                ...
                                <div class="col-4 text-center">
                                    <h1 class="text-gradient text-primary mb-0" style="font-size: 70px;"><span id="status4" countto="417">08</span></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-2">
                        <div class="card-body p-3">
                            <div class="row">
                                ...
                                <div class="col-4 text-center">
                                    <h1 class="text-gradient text-primary mb-0" style="font-size: 70px;"><span id="status4" countto="417">06</span></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input class="form-control" type="month" value="2022-11" id="example-month-input">
                                </div></div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="tab-pane fade show position-relative active border-radius-lg" id="cam1" role="tabpanel" aria-labelledby="cam1">
                                <form class="text_gray">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleFormControlSelect1" class="text_grey">Sector</label>
                                                <select class="form-control" id="exampleFormControlSelect1">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <button type="button" class="btn bg-gradient-info btn-lg">Assign</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <div class="col-lg-12 mb-lg-0 mb-4">
            <div class="row">
                <div class="card">
                    <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1">
                        <div class="row">
                            <div class="col-md-4"><h5 class="text_grey">Data Fields</h5></div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <select class="form-control" id="exampleFormControlSelect1">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <select class="form-control" id="exampleFormControlSelect1">
                                        <option>All The Data Filed</option>
                                        <option>2</option>
                                    </select>
                                </div></div>
                            <div class="col-md-2">
                    ...
                    <div class="card-body p-3">
                        <div class="table-responsive">
                            <table class="table table-flush" id="example2">
                                <thead class="thead-light">
                                <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                        Name
