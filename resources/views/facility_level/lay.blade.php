    ...
    <style>
        .bg-gray-100 {
            background-color: #fff!important;
             ...
             box-shadow: 0px 5px 14px 9px rgb(0 0 0 / 5%);
         }
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="#" target="">
            ...
            <span class="ms-1 font-weight-bold">Welcome! {{auth()->user()->name}}
    ...
    <div class="sidenav-footer mx-3 mt-3 pt-3">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-start p-3 w-100">
                ...
                <div class="docs-info">
                    <h6 class="text-white up mb-0">{{auth()->user()->name}} {{auth()->user()->lname}}</h6>
                    <p class="text-xs font-weight-bold">{{ \App\Cluster::find(auth()->user()->cluster_id)->name}}</p>
                    <p class="text-xs font-weight-bold">{{ \App\Garment::find(auth()->user()->garment_id)->name}}</p>
